...
declare module "../index" {
    ...
    interface LoDashStatic {
         ...
         * @see _.groupBy
         */
        groupBy<T extends object>(collection: T | null | undefined, iteratee?: ValueIteratee<T[keyof T]>): Dictionary<[T[keyof T], ...T[keyof T][]]>;
    }
    interface String {
        /**
         * @see _.groupBy
    ...
    interface Object<T> {
         ...
         * @see _.groupBy
         */
        groupBy(iteratee?: ValueIteratee<T[keyof T]>): Object<Dictionary<[T[keyof T], ...T[keyof T][]]>>;
    }
    interface StringChain {
        /**
         * @see _.groupBy
    ...
    interface ObjectChain<T> {
         ...
         * @see _.groupBy
         */
        groupBy(iteratee?: ValueIteratee<T[keyof T]>): ObjectChain<Dictionary<[T[keyof T], ...T[keyof T][]]>>;
    }
    interface LoDashStatic {
        /**
